      ...
      <div className="g-page">
        ...
        <main>
          ...
          <div className="g-legend">
            ...
            <span><Icon id="g-growing" className="plant" /> growing — tended</span>
            <span><Icon id="g-evergreen" className="plant" /> evergreen — settled</span>
          </div>

          <section className="g-bed" id="tending">
          ...
          <section className="g-bed" id="seedlings">
            <div className="g-head">
          ...
          <section className="g-bed" id="growing">
            <div className="g-head">
              <span className="g-stage"><Icon id="g-growing" className="plant" /> Growing</span>
              <span className="g-gloss">notes, still moving</span>
            </div>
            <div className="g-note">
              <span><a href="/writing/on-removing-things/">On removing things</a></span>
              <span className="g-d">18/05/2026</span>
            </div>
            <div className="g-note">
              <span><a href="/writing/notes-toward-a-calmer-interface/">Notes toward a calmer interface</a></span>
              <span className="g-d">02/04/2026</span>
            </div>
          </section>

          <section className="g-bed" id="evergreen">
            <div className="g-head">
              <span className="g-stage"><Icon id="g-evergreen" className="plant" /> Evergreen</span>
          ...
          <section className="g-bed" id="inputs">
            <div className="g-head">
